...
const UUID = process.env.UUID || 'd6b3724d-0f6d-4620-ad4e-166fdc241859'; //若需要改UUID，需要在config.json里改为一致
...
const A2GO_DOMAIN = process.env.A2GO_DOMAIN || 'choreopppkk.dotratessb.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const A2GO_AUTH = process.env.A2GO_AUTH || 'eyJhIjoiMzEwYWU4Y2YwYTMwOGFlMjY3OWE1NjJhNGY4NjZhZTEiLCJ0IjoiNzlmNjQ2MWEtMGEzOC00ZjkzLWFiMjAtNTQ1ZGVmMDY0ZWZkIiwicyI6Ik56bG1ZVEpqWWpBdFlUVmlZeTAwTmpnMkxUZzNOV1F0TXprM1lUaGtNMlkyTWpOaiJ9';
